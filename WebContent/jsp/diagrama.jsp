		...
		<div class="section">
			<div class="row">
				<form class="col s12" action="#">
					<h5 class="header col s12 light">Documento: <b>Adquisición de un sistema</b></h5>
					<br><br>
					<div class="file-field input-field">
						<div class="btn grey darken-1">
							<span>Importar archivo png</span> <input type="file">
						</div>
						<div class="file-path-wrapper">
							<input class="file-path validate" type="text">
						</div>
					</div>
					<img class="materialboxed" style="width:100%; height:450px;" src="img/sample-1.jpg">
				</form>
			</div>
			<div class="row right">
				<p>adq_sis.doc</p>
				<a class="waves-effect waves-light btn grey darken-1">Descargar</a>
			</div>
		</div>
		<br> <br>
	</div>
